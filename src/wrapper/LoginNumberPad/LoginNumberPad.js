...
const NumberPad = (props) => {
  ...
  const numberList = "7 8 9 4 5 6 1 2 3 clr 0 del";
  ...
  function handleNumberPadLocation(){
    ...
    if(props.numberPadLocation['top'] > 800)
    {
      location = {
        position : 'fixed',
        left : (props.numberPadLocation['left'] + 0) + 'px',
        top : (props.numberPadLocation['top'] + 0) +'px'
      }
    }
    else
    {
